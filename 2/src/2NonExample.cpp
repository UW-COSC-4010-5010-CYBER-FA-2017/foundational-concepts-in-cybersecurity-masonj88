...
This bad example crashes the whole program when a simulated crash in one of the applications happens.
Ideally, the two applications should be isolated so that when one crashes, the other doesn't.
