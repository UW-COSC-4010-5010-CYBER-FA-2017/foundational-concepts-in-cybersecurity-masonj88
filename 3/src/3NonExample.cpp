...
This bad example implements functions to modify object variables, but leaves the variables public
so they can be accessed without the helper functions. (See line 21).
