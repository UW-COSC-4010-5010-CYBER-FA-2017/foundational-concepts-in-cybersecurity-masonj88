/*
    This is a bad example of data hiding because all users and all databases are able to be seen.
    Being able to see all users and all databases allows a potential hacker to have a starting point
    to find an exploit.
*/
...
int main () {
    ...
    string username;
    string passwd;
    cout << "-----Database management tool-----" << endl << "Available Users: " << endl;
    for (int i = 0; i < 4; i++)
    {
        cout << users[i] << endl;
    }
